...
const structuredData = { "@context": "https://schema.org", "@type": "Service", "name": "Content Strategy Services in Berkshire", "description": "Professional content strategy and copywriting for Berkshire businesses. SEO blog writing, content audits, and editorial planning.", "provider": { "@type": "ProfessionalService", "name": "Scalix Studios", "url": "https://scalixstudios.co.uk", "@id": "https://scalixstudios.co.uk/#localbusiness" }, "areaServed": [{ "@type": "Place", "name": "Berkshire, UK" }, { "@type": "Place", "name": "Windsor" }, { "@type": "Place", "name": "Slough" }, { "@type": "Place", "name": "Reading" }, { "@type": "Place", "name": "Maidenhead" }, { "@type": "Place", "name": "Bracknell" }, { "@type": "Place", "name": "Wokingham" }, { "@type": "Place", "name": "Ascot" }, { "@type": "Place", "name": "Staines-upon-Thames" }, { "@type": "Place", "name": "Egham" }, { "@type": "Place", "name": "Henley-on-Thames" }, { "@type": "Place", "name": "Marlow" }, { "@type": "Place", "name": "High Wycombe" }], "url": "https://scalixstudios.co.uk/services/content-strategy", "serviceType": "Content Strategy & Copywriting" }
...
const breadcrumbData = { "@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{ "@type": "ListItem", "position": 1, "name": "Home", "item": "https://scalixstudios.co.uk" }, { "@type": "ListItem", "position": 2, "name": "Services", "item": "https://scalixstudios.co.uk/services" }, { "@type": "ListItem", "position": 3, "name": "Content Strategy", "item": "https://scalixstudios.co.uk/services/content-strategy" }] }

export default function ContentStrategy() {
  const scrollRef = useScrollAnimation()
  return (
    <>
      <SEO title="Content Strategy Berkshire | Copywriting & Blog Writing | Scalix Studios" description="Professional content strategy and copywriting for Berkshire businesses. SEO blog writing, content audits, and editorial planning that drives traffic." keywords="content strategy berkshire, copywriting windsor, blog writing berkshire, content marketing slough, seo copywriting" canonical="https://scalixstudios.co.uk/services/content-strategy" structuredData={[structuredData, faqStructuredData, breadcrumbData]} />

      <ServiceHero breadcrumb="Content Strategy" badge="Content Strategy & Copywriting" badgeColor="bg-orange-500/15 border-orange-500/30 text-orange-300" title="Content Strategy for" highlight="Berkshire Businesses" highlightClass="gradient-text-warm" description="SEO-optimised blog writing, copywriting, and editorial planning that builds authority and drives organic traffic. Strategic content that works while you sleep." cta="Free Content Audit" ctaClass="bg-orange-500 hover:bg-orange-400 text-white" image="/content-strategy-agency.webp" imageAlt="Content strategy planning dashboard" />
