...
const structuredData = { "@context": "https://schema.org", "@type": "Service", "name": "PPC Advertising Services in Berkshire", "description": "Expert PPC and Google Ads management for Berkshire businesses. Immediate leads with targeted pay-per-click campaigns.", "provider": { "@type": "ProfessionalService", "name": "Scalix Studios", "url": "https://scalixstudios.co.uk", "@id": "https://scalixstudios.co.uk/#localbusiness" }, "areaServed": [{ "@type": "Place", "name": "Berkshire, UK" }, { "@type": "Place", "name": "Windsor" }, { "@type": "Place", "name": "Slough" }, { "@type": "Place", "name": "Reading" }, { "@type": "Place", "name": "Maidenhead" }, { "@type": "Place", "name": "Bracknell" }, { "@type": "Place", "name": "Wokingham" }, { "@type": "Place", "name": "Ascot" }, { "@type": "Place", "name": "Staines-upon-Thames" }, { "@type": "Place", "name": "Egham" }, { "@type": "Place", "name": "Henley-on-Thames" }, { "@type": "Place", "name": "Marlow" }, { "@type": "Place", "name": "High Wycombe" }], "url": "https://scalixstudios.co.uk/services/ppc-advertising", "serviceType": "PPC Advertising" }
...
const breadcrumbData = { "@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{ "@type": "ListItem", "position": 1, "name": "Home", "item": "https://scalixstudios.co.uk" }, { "@type": "ListItem", "position": 2, "name": "Services", "item": "https://scalixstudios.co.uk/services" }, { "@type": "ListItem", "position": 3, "name": "PPC Advertising", "item": "https://scalixstudios.co.uk/services/ppc-advertising" }] }

export default function PPCAdvertising() {
  const scrollRef = useScrollAnimation()
  return (
    <>
      <SEO title="PPC Advertising Berkshire | Google Ads Agency Windsor | Scalix Studios" description="Expert PPC and Google Ads management for Berkshire businesses. Precision-targeted campaigns delivering immediate leads and an average 3x return on ad spend. Free PPC audit available." keywords="ppc advertising berkshire, google ads agency windsor, ppc management slough, pay per click reading, facebook ads berkshire" canonical="https://scalixstudios.co.uk/services/ppc-advertising" structuredData={[structuredData, faqStructuredData, breadcrumbData]} />

      <ServiceHero breadcrumb="PPC" badge="Pay-Per-Click Advertising" badgeColor="bg-emerald-500/15 border-emerald-500/30 text-emerald-300" title="Google Ads Management in" highlight="Berkshire" highlightClass="gradient-text-green" description="Precision-targeted Google Ads and social media campaigns for Berkshire businesses. Average 3x return on ad spend. First leads typically within 7 days of campaign launch." cta="Free PPC Audit" ctaClass="bg-emerald-500 hover:bg-emerald-400 text-white" image="/ppc-advertising-berkshire.webp" imageAlt="PPC advertising campaign dashboard" />
